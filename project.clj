(def MAIN 'rename-trash-icon-on-ubuntu-20-04.main)
...
(defproject program "0.1.0"
  ...
  :profiles {:dev  {:main         ^{:skip-aot false} ~MAIN
             ...
             :prod ^:leaky {:main ~MAIN
                            :uberjar-name "rename-trash-icon-on-ubuntu-20-04.standalone.jar"
                            :jar-name     "rename-trash-icon-on-ubuntu-20-04.jar"
                            :uberjar-exclusions []
